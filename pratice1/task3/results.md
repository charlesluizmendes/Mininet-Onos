```
charles@charles-pc:~/Projetos/Mininet-Onos/pratice1/task3$ sudo ./run.sh single hosts=13
Executando a topologia single com parâmetros adicionais:  hosts=13
...
```
charles@charles-pc:~/Projetos/Mininet-Onos/pratice1/task3$ sudo ./run.sh linear switches=10 hosts=10
Executando a topologia linear com parâmetros adicionais:  switches=10 hosts=10
...
```
charles@charles-pc:~/Projetos/Mininet-Onos/pratice1/task3$ sudo ./run.sh tree depth=4 fanout=5
Executando a topologia tree com parâmetros adicionais:  depth=4 fanout=5
