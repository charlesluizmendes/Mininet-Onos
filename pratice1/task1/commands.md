...
```
sudo mn --topo single,10 --controller remote,ip=192.168.0.100,port=6653 --switch ovs,protocols=OpenFlow13 --test pingall
```
...
h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 
*** Done
completed in 6.050 seconds
```

```
sudo mn --topo linear,5 --controller remote,ip=192.168.0.100,port=6653 --switch ovs,protocols=OpenFlow13 --test pingall
```
...
h1 h2 h3 h4 h5 
*** Done
completed in 5.832 seconds
```

```
sudo mn --topo tree,depth=3,fanout=2 --controller remote,ip=192.168.0.100,port=6653 --switch ovs,protocols=OpenFlow13 --test pingall
```
